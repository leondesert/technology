...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="avs-logo text-center">
        <img src="<?= base_url(); ?>dist/img/avs_logo.png" alt="avs-logo" style="width: 120px; padding-top: 20px">
    </div>
    
    <div class="card-header text-center">
      <a href="/" class="h1"><b></b>Technology</a>
    </div>
